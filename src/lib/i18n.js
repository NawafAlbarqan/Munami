...
const STRINGS = {
  en: {
    ...
    navHome: 'Home',
    navBudget: 'Budget',
    monthlyOverviewNav: 'Monthly',
    monthlyOverview: 'Monthly overview',
    monthlyOverviewEyebrow: 'Your complete month',
    savings: 'Savings',
    ...
    openBudgetDesc: 'Limits, bills and recommendations',
    editCash: 'Edit cash',
    editCashDesc: 'Add or withdraw cash',
    editBudget: 'Edit budget',
    editBill: 'Edit bill',
    editBills: 'Edit bills',
    addBill: 'Add bill',
    billName: 'Bill name',
    billNamePlaceholder: 'e.g. Internet',
    billAmount: 'Amount (SAR)',
    ...
    cashDeposit: 'Add money',
    cashWithdrawal: 'Withdraw',
    optionalDescription: 'Description (optional)',
    cashDescriptionPlaceholder: 'What was this for?',
    cashTransactionHelp: 'Descriptions help Monami categorize this transaction automatically.',
    cashAvailable: (amount) => `${amount} available to withdraw`,
    recordCashTransaction: 'Record transaction',
    addCashAction: 'Add',
    savingCash: 'Categorizing…',
  ...
  ar: {
    ...
    navHome: 'الرئيسية',
    navBudget: 'الميزانية',
    monthlyOverviewNav: 'الشهر',
    monthlyOverview: 'النظرة الشهرية',
    monthlyOverviewEyebrow: 'شهرك بالكامل',
    savings: 'الادخار',
    ...
    openBudget: 'فتح الميزانية',
    openBudgetDesc: 'الحدود والفواتير والتوصيات',
    editCash: 'تعديل النقد',
    editCashDesc: 'إضافة أو سحب مبلغ نقدي',
    editBudget: 'تعديل الميزانية',
    editBill: 'تعديل الفاتورة',
    editBills: 'تعديل الفواتير',
    addBill: 'إضافة فاتورة',
    billName: 'اسم الفاتورة',
    billNamePlaceholder: 'مثل: الإنترنت',
    billAmount: 'المبلغ (ريال)',
    billDueDate: 'تاريخ الاستحقاق',
    ...
    cashAction: 'حركة النقد',
    cashDeposit: 'إضافة مبلغ',
    cashWithdrawal: 'سحب مبلغ',
    optionalDescription: 'الوصف (اختياري)',
    cashDescriptionPlaceholder: 'وش كان سبب الحركة؟',
    cashTransactionHelp: 'الوصف يساعد منمّي يصنّف المعاملة تلقائياً.',
    cashAvailable: (amount) => `${amount} متاح للسحب`,
    recordCashTransaction: 'تسجيل الحركة',
    addCashAction: 'إضافة',
    savingCash: 'جاري التصنيف…',
